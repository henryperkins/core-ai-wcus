...
// stops presenting the Connectors setup grid as a formal state machine. Match
// the complete former notes array so an author who changed any note keeps it.
const FIRST_FLOW_REVIEW_V325_DEFAULTS = {
	panels: {
		client: {
			notes: [
				{
